  ...
  return (
    <div className="container px-8 mx-auto mt-16 lg:mt-32 ">
      ...
      {link ? (
        ...
        >
          <Title style={{ color: '#7dffb3', textShadow: '0 0 10px #3aa57a' }}>Encrypt and Share</Title>
          ...
          <div className="mt-8">
            ...
            <hr />
            <br />
            <img src="/img/wallet.png" style={{ maxWidth: '25%', height: 'auto', display: 'block', margin: '1rem auto', border: '2px solid #7dffb3', opacity: 0.45 }} />
            <br />
            <p className="text-center text-sm">Services are currently free, please donate to the address below to keep S.L.I.V.E.R. online in S.I.L.E.N.C.E</p>
            <br />
            <p style={{ textAlign: 'center' }}>BTC: bc1q6pz3ws8l4t07cnxrt7df2n8zgqfcg4q5p27z2l</p>
            <br />
            <hr />
            <br />
          </div>
